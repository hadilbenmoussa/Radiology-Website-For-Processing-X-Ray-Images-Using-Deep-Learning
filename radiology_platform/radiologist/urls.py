...
urlpatterns = [
    ...
    path(
        "radiologist/createappointment<int:report_id>",
        views.create_appointment,
        name="create_appointment",
    ),
    path(
        "radiologist/update_appointment/<int:appointment_id>/",
        views.update_appointment,
        name="update_appointment",
    ),
    path(
        "radiologist/appointments/<int:appointment_id>/delete/",
        views.delete_appointment,
        name="delete-appointment",
    ),
    path(
        "radiologist/reports/<int:appointment_id>/delete/",
        views.delete_report,
        name="delete_report",
    ),
    path(
        "radiologist/generatereport<int:report_id>",
    ...
    path(
        "radiologist/patients/<int:patient_id>/medical_history",
        views.medical_history,
        name="rad_medical_history",
    ),
    path("radiologist/reports", views.reportsView, name="rad_reports"),
    path("radiologist/blog", views.addblogView, name="rad_addblog"),
    path("radiologist/profile/<str:username>/", views.profileView, name="rad_profil"),
    path(
        "radiologist/notifications", views.notificationsView, name="rad_notifications"
    ),
